...
O comando usa o GHC de `$GHC` ou do PATH quando presente, e recorre ao
GHC registrado no pacote; ele compila contra as fontes instaladas e
liga a ponte C incluída.
